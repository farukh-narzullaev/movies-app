...
@section('content')
	<div class="movie-info border-b border-gray-800">
		<div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
			<img src="/img/parasite.jpg" alt="parasite" class="w-68 md:w-96">
			<div class="md:ml-24">
				...
				<p class="text-gray-300 mt-8">
					Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin ultrices maximus viverra. Aliquam gravida iaculis metus ut finibus. Nam in risus pharetra, commodo dui ut, lacinia sapien. Phasellus ut hendrerit enim. In at fermentum diam, ac scelerisque metus. In vitae mattis quam. Etiam sit amet dignissim arcu. Aliquam in ante a leo auctor scelerisque. Sed iaculis pretium sapien, eu condimentum tellus laoreet vitae. Ut a diam vitae orci rhoncus mattis non a risus. Proin pellentesque ut mauris a placerat.
				</p>
